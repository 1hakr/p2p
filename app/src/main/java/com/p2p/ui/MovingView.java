...
public class MovingView extends FrameLayout {
    ...
    private Runnable mSwapImageRunnable = new Runnable() {
        ...
        public void run() {
            swapImage();
            mHandler.postDelayed(mSwapImageRunnable, mSwapMs - mFadeInOutMs*5);
        }
    };
    ...
    private void swapImage() {
        ...
        if(mActiveImageIndex == -1) {
            mActiveImageIndex = 1;
            animateView(mImageViews[mActiveImageIndex]);
            return;
        }
        ...
        animateView(activeImageView);

       // Utils.crossfade(activeImageView, inactiveImageView, mCrossFadeMs, null);
        
        ViewHelper.setAlpha(activeImageView, 0.0f);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(mCrossFadeMs);
    ...
    protected void onFinishInflate() {
        ...
        View view = inflate(getContext(), R.layout.view_moving, this);
